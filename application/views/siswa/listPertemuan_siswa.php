  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="<?php echo site_url('siswa/overviewSiswa') ?>">Dashboard</a>
      </li>
      <li class="breadcrumb-item active">Pertemuan</li>
    </ol>
    <?php if ($this->session->userdata('level') == 'Siswa') { ?>
      <!-- <div align="left">
        <a href="<?php echo base_url('siswa/materi/tambahPertemuan/' . $KodeKelas . '/' . $KodeMapel); ?>" class="btn btn-success">Tambah Pertemuan <?= $mapel[0]->NamaMapel ?> - <?= $kelas->NamaKelas ?></a>
      </div> -->
      <br>
          ...
          <tr>
            ...
            <td>
              <div class="table-data-feature">
                ...
                <a href="<?= base_url('siswa/materi/listMateri/') . $key->KodePertemuan . '/' . $key->KodeKelas . '/' . $key->KodeMapel ?>" class="item" data-toggle="tooltip" data-placement="top" title="Tambah">
                  <i class="btn btn-info">Lihat Materi</i>
                </a>
              </div>
            </td>
          </tr>
