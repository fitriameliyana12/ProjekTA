<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <a href="<?php echo base_url('index.php/admin/siswa/tambah/'); ?>" class="btn btn-success">Tambah</a>
      ...
      <br>
      <center><h3><strong>Rencana Pembelajaran</strong></h3></center><br>
    <?php } ?>
                  ...
                  if ($key->KodeKelas == $siswa->KodeKelas) { ?>
                    <div class="card card-body">
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          <tbody>
                            <?php foreach ($kontrakkelas as $k) {
                              if ($key->KodeKelas == $k->KodeKelas) { ?>
                                <tr>
                                  <td width="80%"><?= $k->NamaMapel ?></td>
                                  <td><a href="<?= base_url() ?>siswa/kontrak/listKontrak/<?=
                                                                                    $k->KodeKelas ?>/<?= $k->Kodemapel ?>" class="btn btn-primary">Reancana Pembelajaran</a></td>
                                </tr>
                            <?php }
                            } ?>
                          </tbody>
