<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <a href="<?php echo base_url('index.php/admin/siswa/tambah/'); ?>" class="btn btn-success">Tambah</a>
      ...
      <br>
      <center><h3><strong>Absensi Siswa</strong></h3></center><br>
    <?php } ?>
                            ...
                            <?php foreach ($mapel as $k) {
                              if ($key->KodeKelas == $k->KodeKelas) { ?>
                                <tr>
                                  ...
                                  <td><a href="<?= base_url() ?>siswa/absen/listAbsen/<?=
                                                                                    $k->KodeKelas ?>/<?= $k->KodeMapel ?>" class="btn btn-primary">Cek Absensi</a></td>
                                </tr>
                            <?php }
                            } ?>
                          </tbody>
