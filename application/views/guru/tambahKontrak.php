<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Upload Rencana Pembelajaran</li>
    </ol>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-8">
              ...
              <form action="<?= base_url('guru/kontrak/prosesUploadKontrak') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="card">
                  <div class="card-header">
                    <strong>Tambah Rencana Pembelajaran</strong>
                  </div>
                  <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        ...
                        <small class="form-text text-muted">Tulislah Judul Rencana Pembelajaran</small>
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col col-md-3">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="tgl_posting" placeholder="Tanggal Posting" readonly value="<?php 
                    ...
                    <div class="row form-group">
                      <div class="col col-md-3">
                        <label for="text-input" class=" form-control-label">Upload Rencana Pembelajaran</label>
                      </div>
                      <div class="col-12 col-md-9">
                        <input type="file" id="text-input" name="kontrak" class="form-control">
                        <small class="form-text text-muted">Format file pdf, word, excel, ppt, etc.</small>
                      </div>
                    </div>
                  </div>
