<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Upload File Pertemuan</li>
    </ol>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-8">
              ...
              <form action="<?= base_url('guru/tugas/prosesUploadPertemuan') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="card">
                  <div class="card-header">
                    <strong>Tambah Pertemuan</strong>
                  </div>
                  <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                      <div class="col col-md-3">
                        <label for="text-input" class=" form-control-label">Pertemuan Ke-</label>
                      </div>
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="pertemuan" placeholder="Pertemuan...." class="form-control">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" readonly value="<?= $kelas[0]->NamaKelas ?>" name="kodeKelas" placeholder="kodeKelas" class="form-control">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" readonly value="<?= $mapel[0]->NamaMapel ?>" name="kodeMapel" placeholder="kodeMapel" class="form-control">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="tgl_pertemuan" placeholder="Tanggal Pertemuan" readonly value="<?php 
                    ...
                    <div class="row form-group">
                      <div class="col col-md-3">
                        <label for="text-input" class=" form-control-label">Upload File Rencana Pembelajaran</label>
                      </div>
                      <div class="col-12 col-md-9">
