<div id="content-wrapper">
  ...
  <a href="<?php echo base_url('index.php/admin/guru/tambah/'); ?>" class="btn btn-success">Tambah</a>
      ...
      <br>
      <center><h3><strong>Detail Rencana Pembelajaran</strong></h3></center><br>
    <?php } ?>
    <!-- MAIN CONTENT-->
              ...
              <?php foreach ($kontrak as $key) { ?>
                <div class="card">
                  <div class="card-header">
                    <strong>Detail Reancana Pembelajaran</strong>
                  </div>
                  <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                      <div class="col col-md-7">
                        <p>Download File Rencana Pembelajaran | <a href="<?= base_url() . "guru/kontrak/downloadKontrak/" . $key->file ?>"><?php echo $key->file ?></a></p>
                      </div>
                    </div>
                  </div>
                </div>
