<div id="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <?php if ($this->session->userdata('level') == 'Guru') { ?>
            ...
            <br>
            <center><h3><strong>Edit Tugas </strong></h3></center>
        <?php } ?>
        <br>
        <!-- MAIN CONTENT-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <form action="<?= base_url('guru/tugas/prosesUpdateTugas/'.$tugas[0]->id_tugas) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <input type="hidden" id="text-input" value="<?= $KodePertemuan?>" name="KodePertemuan" placeholder="KodePertemuan" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="judul" placeholder="Judul" class="form-control" value="<?= $tugas[0]->judul ?>">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="tgl_posting" placeholder="Tanggal Posting" readonly value="<?= $tugas[0]->tgl_posting ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="isi" id="isi" rows="9" placeholder="Isi Pesan..." class="form-control"><?= $tugas[0]->isi ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">File Tugas</label>
                                            </div>
                                            <div class="col-12 col-md-9">
