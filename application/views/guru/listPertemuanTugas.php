<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <?php if ($this->session->userdata('level') == 'Guru') { ?>
      <div align="left">
        <a href="<?php echo base_url('guru/tugas/tambahPertemuan/' . $KodeKelas . '/' . $KodeMapel); ?>" class="btn btn-success">Tambah Pertemuan <?= $mapel[0]->NamaMapel ?> - <?= $kelas->NamaKelas ?></a>
      </div>
      <br>
          ...
          <tr>
            ...
            <td>
              <div class="table-data-feature">
                <a href="<?= base_url('guru/tugas/detailPertemuan/') . $key->id_pertemuan ?>" class="item" data-toggle="tooltip" data-placement="top" title="Open">
                  <i class="btn btn-info">Detail</i>
                </a>
                <a href="<?= base_url('guru/tugas/editPertemuan/') . $key->id_pertemuan ?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                  <i class="btn btn-warning">Edit</i>
                </a>
                <a href="<?= base_url('guru/tugas/list/') . $key->id_pertemuan . "/" . $KodeKelas . "/" . $KodeMapel ?>" class="item" data-toggle="tooltip" data-placement="top" title="Tambah">
                  <i class="btn btn-success">Tambah Tugas</i>
                </a>
              </div>
            </td>
          </tr>
