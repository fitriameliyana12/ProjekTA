<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <a href="<?php echo base_url('index.php/admin/guru/tambah/'); ?>" class="btn btn-success">Tambah</a>
      ...
      <br>
      <center><h3><strong>Rencana Pembelajaran</strong></h3></center>
    <?php } ?>
                ...
                <?php foreach ($kelas as $k) { ?>
                  <div class="card card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        <tbody>
                          <?php foreach ($kontrakKelas as $m) {
                            if ($k->KodeKelas == $m->KodeKelas) {
                          ?>
                              <tr>
                                <td width="100%"><?= $m->NamaMapel ?></td>
                                <?php if ($m->KodeGuru == $guru->KodeGuru) { ?>
                                  <td><a href="<?= base_url() ?>guru/kontrak/list/<?=
                                                                                $m->KodeKelas ?>/<?= $m->Kodemapel ?>/" class="btn btn-primary">+ Kontrak</a></td>
                                <?php } else { ?>
                                  <td></td>
                                <?php } ?>
                              </tr>
