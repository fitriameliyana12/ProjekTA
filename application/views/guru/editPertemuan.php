<div id="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <?php if ($this->session->userdata('level') == 'Guru') { ?>
            ...
            <br>
            <center><h3><strong>Edit Pertemuan </strong></h3></center>
        <?php } ?>
        <br>
        <!-- MAIN CONTENT-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <form action="<?= base_url('guru/tugas/prosesUpdatePertemuan/'.$pertemuan[0]->id_pertemuan) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit Pertemuan</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="pertemuan" placeholder="Pertemuan" class="form-control" value="<?= $pertemuan[0]->pertemuan ?>">
                                                <small class="form-text text-muted">Tulislah Judul yang sesuai dengan Pertemuan</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="tgl_pertemuan" placeholder="Tanggal Pertemuan" readonly value="<?= $pertemuan[0]->tgl_pertemuan ?>" class="form-control">
                                            </div>
                                        </div>
                                        <!-- <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="datetime-local" id="text-input" name="deadline" placeholder="Deadline" class="form-control" value="<?php echo date("Y-m-d\TH:i", strtotime($tugas[0]->deadline)); ?>">
                                            </div>
                                        </div> -->
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="isi" id="isi" rows="9" placeholder="Isi Pesan..." class="form-control"><?= $pertemuan[0]->isi ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">File Pertemuan</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="file" id="text-input" name="pertemuan" class="form-control">
                                                <p>NB: isi file pertemuan ketika ingin merubah file pertemuan</p>
                                            </div>
                                        </div>
