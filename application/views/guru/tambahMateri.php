        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-8">
              ...
              <form action="<?= base_url('guru/materi/prosesUploadMateri') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="card">
                  ...
                  <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        ...
                        <small class="form-text text-muted">Tulislah Judul yang sesuai dengan Materi</small>
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col col-md-3">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" readonly value="<?= $mapel[0]->NamaMapel ?>" name="mapel" placeholder="mapel" class="form-control">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" readonly value="<?= $pertemuan[0]->NamaPertemuan ?>" name="pertemuan" placeholder="pertemuan" class="form-control">
                    ...
                    <div class="row form-group">
                      <div class="col col-md-3">
                        <label for="text-input" class=" form-control-label">File Materi</label>
                      </div>
                      <div class="col-12 col-md-9">
