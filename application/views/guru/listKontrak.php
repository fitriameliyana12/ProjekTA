<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <?php if ($this->session->userdata('level') == 'Guru') { ?>
      <div align="left">
        <a href="<?php echo base_url('guru/kontrak/tambah/' . $KodeKelas . '/' . $KodeMapel); ?>" class="btn btn-success">Tambah Kontrak <?= $mapel[0]->NamaMapel ?> - <?= $kelas->NamaKelas ?></a>
      </div>
      <br>
      <center><h3><strong>Daftar Kontrak</strong></h3></center>
    <?php } ?>
    <br>
          ...
          <tr>
            ...
            <td>
              <div class="table-data-feature">
                <a href="<?= base_url('guru/kontrak/detailKontrak/') . $key->id_kontrak ?>" class="item" data-toggle="tooltip" data-placement="top" title="Open">
                  <i class="btn btn-info">Detail</i>
                </a>
                <a href="<?= base_url('guru/kontrak/editKontrak/') . $key->id_kontrak ?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                  <i class="btn btn-warning">Edit</i>
                </a>
                <a href="<?= base_url('guru/kontrak/hapusKontrak/') . $key->id_kontrak . "/" . $KodeKelas . "/" . $KodeMapel ?>" class="item" data-toggle="tooltip" data-placement="top" title="Hapus">
