        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-8">
              ...
              <form action="<?= base_url('guru/tugas/prosesUploadTugas') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="card">
                  ...
                  <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <input type="text" id="text-input" readonly value="<?= $Pertemuan[0]->NamaPertemuan ?>" name="kodePertemuan" placeholder="kodePertemuan" class="form-control">
