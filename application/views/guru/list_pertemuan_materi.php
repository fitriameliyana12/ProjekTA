          ...
          <tr>
            ...
            <td>
              <div class="table-data-feature">
                ...
                <a href="<?= base_url('guru/materi/listMateri/') . $key->KodePertemuan . '/' . $key->KodeKelas . '/' . $key->KodeMapel ?>" class="item" data-toggle="tooltip" data-placement="top" title="Tambah">
                  <i class="btn btn-info">Tambah Materi</i>
                </a>
              </div>
            </td>
          </tr>
