...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Pertemuan Kelas</li>
  </ol>
  <?php if ($this->session->userdata('level') == 'Admin'){ ?>
  <div align="left">
    <a href="<?php echo base_url('index.php/admin/pertemuanKelas/tambah/'); ?>" class="btn btn-success">Tambah</a>
  </div>
  <br>
  <center><h3><strong>Daftar Pertemuan Per-Kelas</strong></h3></center>
<?php } ?>
      ...
      <table class="table table-hover" id="myTable">
        ...
        <tbody id="isi_kelas">
          <?php $no=1; foreach ($pertemuanKelasList as $key) { ?>
            <tr>
              <td><?php echo $no; ?></td>
              <td><?php echo $key->id; ?></td>
              <td><?php echo $key->KodePertemuan; ?></td>
              ...
              <td><?php echo $key->NamaGuru; ?></td>
                ...
                <?php if ($this->session->userdata('level') == 'Admin') { ?>
              <td>
                <a href="<?php echo base_url('index.php/admin/pertemuanKelas/edit/');echo $key->id; ?>" class="btn btn-warning">Edit</a> <a onclick="return confirm('Apakah yakin ingin hapus?')" href="<?php echo base_url('index.php/admin/pertemuanKelas/hapus/');echo $key->id; ?>" class="btn btn-danger">Hapus</a>
              </td>
              <?php } ?>
            </tr>
          <?php $no++; } ?>
