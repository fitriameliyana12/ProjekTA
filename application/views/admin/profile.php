      ...
      <div class="section__content section__content--p30">
        <div class="container-fluid">
          ...
          <div class="map-data m-b-40">
            <h3 class="title-3 m-b-30">Profile Admin</h3>
            ...
            <div class="filters">
              <form action="<?= base_url('admin/profile/updategambar') ?>" enctype="multipart/form-data" method="post" class="row form-group">
              ...
              <!-- <form action="<?= base_url('admin/updateprofile/') . $this->session->userdata('id_User'); ?>" method="post"> -->
