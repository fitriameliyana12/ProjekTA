...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Jam Pelajaran Selama Daring</li>
  </ol>
  <?php if ($this->session->userdata('level') == 'Admin'){ ?>
  <div align="left">
    <a href="<?php echo base_url('index.php/admin/Jam_pelajaran/tambah/'); ?>" class="btn btn-success">Tambah</a>
  </div>
  <br>
<?php } ?>
<center><h3><strong>Jam Pelajaran Selama Daring</strong></h3></center>
      <br>
      <table class="table table-hover" id="myTable">
        ...
        <tbody id="isi_jam">
          <?php $no=1; foreach ($jamList as $key) { ?>
            <tr>
              <td><?php echo $no; ?></td>
              ...
              <td><?php echo $key->keterangan; ?></td>
                ...
                <?php if ($this->session->userdata('level') == 'Admin') { ?>
              <td>
                <a href="<?php echo base_url('index.php/admin/Jam_pelajaran/edit/');echo $key->id; ?>" class="btn btn-warning">Edit</a> <a onclick="return confirm('Apakah yakin ingin hapus?')" href="<?php echo base_url('index.php/admin/Jam_pelajaran/hapus/');echo $key->id; ?>" class="btn btn-danger">Hapus</a>
