...
<div class="container-fluid">
  ...
  <div align="left">
    <a href="<?php echo base_url('index.php/admin/pertemuan/tambah/'); ?>" class="btn btn-success">Tambah</a>
  </div>
  <br>
  <center><h3><strong>Daftar Pertemuan Kelas</strong></h3></center>
<?php } ?>
      ...
      <table class="table table-hover" id="myTable">
        ...
        <tbody id="isi_kelas">
          <?php $no=1; foreach ($pertemuanList as $key) { ?>
            <tr>
              <td><?php echo $no; ?></td>
              ...
              <td><?php echo $key->tgl_pertemuan; ?></td>
                <?php if ($this->session->userdata('level') == 'Admin') { ?>
              <td>
                <a href="<?php echo base_url('index.php/admin/pertemuan/edit/');echo $key->KodePertemuan; ?>" class="btn btn-warning">Edit</a> <a onclick="return confirm('Apakah yakin ingin hapus?')" href="<?php echo base_url('index.php/admin/pertemuan/hapus/');echo $key->KodePertemuan; ?>" class="btn btn-danger">Hapus</a>
              </td>
              <?php } ?>
            </tr>
          <?php $no++; } ?>
