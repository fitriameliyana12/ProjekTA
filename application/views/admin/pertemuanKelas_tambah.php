...
<div class="container-fluid">
  ...
  <center><h2>Tambah Data Pertemuan Kelas Siswa</h2></center><br>
  <?php 
  echo form_open('index.php/admin/pertemuanKelas/tambah/'); 
...
<div class="form-group">
        ...
        <?php foreach ($pertemuanList as $key) { ?>
            <option value ="<?php echo $key->KodePertemuan ?>"><?php echo $key->NamaPertemuan ?></option>
        <?php } ?>
        </select>
    </div>
